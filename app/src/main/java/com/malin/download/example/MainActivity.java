package com.malin.download.example;
...
import com.malin.download.example.basic_download.BasicDownloadActivity;
import com.malin.download.example.databinding.ActivityMainBinding;
import com.malin.download.example.download_manager.AppMarketActivity;
import com.malin.download.example.multi_mission.MultiMissionDownloadActivity;
import com.malin.download.example.service_download.ServiceDownloadActivity;
...
public class MainActivity extends AppCompatActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		//
		Utils.setDebug(true);
		MalinDownload.getInstance(this)
				.maxDownloadNumber(2)
				.maxThread(3);
	}
